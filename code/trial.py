...
binned_col_series = BinningMachine.perform_binning_on_col(col_df, {"column": "person_age", "type": "numerical", "bins": "none"})

print(binned_col_series)
print(type(binned_col_series))

temp_df = df.copy()
temp_df['binned_col'] = binned_col_series.values

print(temp_df)

print(temp_df['binned_col'])