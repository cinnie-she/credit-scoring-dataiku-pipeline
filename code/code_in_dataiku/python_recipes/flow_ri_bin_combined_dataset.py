...
# Read recipe inputs
combined_accept_reject_dataset = dataiku.Dataset("combined_accept_reject_dataset")
df = combined_accept_reject_dataset.get_dataframe()

# Decode bins_settings
...
binned_combined_dataset_df = BinningMachine.perform_binning_on_whole_df(df, bins_settings)


# Write recipe outputs
binned_combined_dataset = dataiku.Dataset("binned_combined_dataset")
binned_combined_dataset.write_with_schema(binned_combined_dataset_df)
